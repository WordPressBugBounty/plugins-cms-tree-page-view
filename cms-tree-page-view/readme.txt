...
Tags: pages, tree, drag-and-drop, custom post types, page order
...
theme outputs your pages, so to show them on your website in the same order as they appear in
the tree, the query that outputs them must sort by `menu_order`:
...
// Using wp_list_pages() or a navigation menu
wp_list_pages( array(
...
- preparing for translation, using \_\_ and \_e
